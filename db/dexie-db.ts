...
class MyAppDatabase extends Dexie {
  ...
  constructor() {
    super('MyAppDatabase');
    this.currentVersion = parseInt(localStorage.getItem('dbVersion') || '1', 10);

    this.version(this.currentVersion).stores({
      ...
      chats: 'id, user_id, friend_id, last_message, timestamp, is_group, name, avatar_url, unread_count',
    });
